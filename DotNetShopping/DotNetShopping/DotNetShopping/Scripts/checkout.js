$(document).ready(function () {
    ...
    $("#ShippingMethodId").change(function () {
        if ($(this).val() > 0) {
            ...
            $('#ShippingCost').html('$' + cost.toFixed(2));
            $('#shipping-total').html('$' + cost.toFixed(2));
...
function testValues() {
    $('#BillingFirstName').val('Ahmet Gökhan');
    $('#BillingLastName').val('Kaya');
    $('#BillingCompany').val('Xapps');
    $('#BillingStreet1').val('KocatepeSt');
    $('#BillingStreet2').val('Yenibosna');
    $('#BillingCountryId').val(1);
    billingCountryChanged(2, 8);
    $('#BillingZip').val('34196');
    $('#BillingTelephone').val('5375047300');
    $('#BillingEmail').val('semih_ahmet123@outlook.com');
}
